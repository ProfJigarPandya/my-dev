...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
REM INSERTING into PRODUCT_MASTER
SET DEFINE OFF;
...
Insert into PRODUCT_MASTER (PRODUCT_NO,DESCRIPTION,PROFIT_PERCENT,UNIT_MEASURE,QTY_ON_HAND,REORDER_LVL,SELL_PRICE,COST_PRICE) values ('P07865','1.22floppies',5,'piece',100,20,525,500);
