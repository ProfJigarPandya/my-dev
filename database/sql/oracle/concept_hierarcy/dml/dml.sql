...
select lft.location_name myself, rgt.location_name myparent from location_conc_hier lft join location_conc_hier rgt on lft.parent_lch_id = rgt.location_id order by lft.parent_lch_id;