...
//After minute number k, the fly jumps over k - 1 cups (clockwise) and lands and the next one. For example, after the
//first minute the fly ends up at the neighboring cup, and after that at the third cup from the start.
...
//Assuming that the fly is sitting on 0th place initially.
...
//jumps 1    3    6   10   15   21   28   36   45   55   66   78   91  105  120  136  153  171  190  210  231  253  276  300  325  351  378  406  435  465  496  528  561  595  630  666  703  741  780  820  861  903  946  990

//void displayLookup()
//{
//    //Possible lookup numbers of cup where the fly can sit
//	  #define MAXN 1000
//	  int time=1;
//	  cout<<"time ";
//
...
//	    int sumover=0;
//
//	    for(time=1;time<=MAXN;time++)
//	    {
//	  	sumover=(time*(time+1)/2);
//	  	if(sumover>MAXN)
//	  		break;
//	      lookup.insert(sumover);
//	    }
//
//	  for (time=1;time<=MAXN;time++)
//	  {
...
// One observation: 1+2+3+4+5+... is the time getting added everystep. n(n+1)/2.
